...
namespace Repres.Shared.Constants.Permission
{
    public static class Permissions
    {
        public static class Apis
        {
            public const string View = "Permissions.Apis.View";
            public const string Edit = "Permissions.Apis.Edit";
            public const string Search = "Permissions.Apis.Search";
        }
