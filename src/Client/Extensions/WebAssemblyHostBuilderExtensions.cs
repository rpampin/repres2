...
using Repres.Client.Infrastructure.Authentication;
using Repres.Client.Infrastructure.Managers;
using Repres.Client.Infrastructure.Managers.Preferences;
...
using Repres.Client.Infrastructure.Managers.ExtendedAttribute;
using Repres.Domain.Entities.ExtendedAttributes;
using Repres.Domain.Entities.Misc;
using Toolbelt.Blazor.Extensions.DependencyInjection;

namespace Repres.Client.Extensions
{
