...
using Repres.Application.Features.ExtendedAttributes.Commands.Delete;
...
using Repres.Application.Features.ExtendedAttributes.Queries.GetById;
using Repres.Domain.Contracts;
using Microsoft.AspNetCore.Mvc;

namespace Repres.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
